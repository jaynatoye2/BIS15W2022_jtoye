...
R is a specific type of programming language, originally used to statistics while RStudio is the environment that runs the R language to develop statistical programs. GitHub is a platform for sharing code and is used to keep track of a person's coding progress. 
