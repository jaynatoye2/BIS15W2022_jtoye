...
venn_plot +
  scale_fill_distiller(palette = "Blues")+ #distiller is for discrete data
...
four_cat_vec <- list(swimming_vec, carni_vec, aqua_vec, ecto_vec)

# Make the plot:
ggVennDiagram(four_cat_vec, category.names = c("Swimming", "Carnivore", "Aquatic", "Ectotherm"))
```
